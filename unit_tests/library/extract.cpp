...
{
    osrm::ExtractorConfig config;
    config.profile_path = "/opt/car.lua";
    config.input_path = /* OSRM_TEST_DATA_DIR */ "/data/monaco/monaco.osm.pbf";
    config.UseDefaultOutputNames(/*OSRM_TEST_DATA_DIR*/ "/data/monaco/monaco.osm.pbf");
    config.requested_num_threads = tbb::task_scheduler_init::default_num_threads();
